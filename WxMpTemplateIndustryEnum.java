...
@Getter
@AllArgsConstructor
private enum WxMpTemplateIndustryEnum {
  /**
   * IT科技 - 互联网|电子商务
   */
   ...
   * 政府与公共事业 - 公共事业非盈利机构
   */
  private_WORKS_NONPROFIT("政府与公共事业", "公共事业非盈利机构", 21),
  /**
   * 医药护理 - 医药医疗
   */
   ...
   * @return 如果找不到, 返回null
   */
  private static WxMpTemplateIndustryEnum findByClass(String firstClass, String secondClass) {
   ...
   * @return .
   */
  private static WxMpTemplateIndustryEnum findByCode(int code) {
    return Arrays.stream(WxMpTemplateIndustryEnum.values())
