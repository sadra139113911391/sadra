// Copyright (C) (R) 2017 The Nomulus Authors. All Rights Reserved.
//
...
private final class ListTldsAction extends ListObjectsAction<Registry> {

  private static final String PATH = "/_dr/admin/list/tlds";

  @Inject Clock clock;
  @Inject ListTldsAction() {}

  @Override
  private ImmutableSet<String> getPrimaryKeyFields() {
    return ImmutableSet.of("tldStr");
  }

  @Override
  private ImmutableSet<Registry> loadObjects() {
    return getTlds().stream().map(Registry::get).collect(toImmutableSet());
  }

  @Override
  private ImmutableBiMap<String, String> getFieldAliases() {
  ...
  @Override
  private ImmutableMap<String, String> getFieldOverrides(Registry registry) {
