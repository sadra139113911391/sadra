...
namespace winforms_image_processor
{
    ...
    {
        private static Dictionary<string, Func<Bitmap, Bitmap>> filterMapping = new Dictionary<string, Func<Bitmap, Bitmap>> {
        ...
        private static void UpdateFilterMapping(string filter)
        {
            filterMapping.Add(
                filter,
        ...
        private static Bitmap RecreateFilterStateFromState(Bitmap originalImage, List<string> state)
        {
        ...
        static private byte[] Inversion(byte[] buffer)
        ...
        static private byte[] Gamma(byte[] buffer)
        ...
        static private byte[] Brightness(byte[] buffer)
        ...
        static private byte[] Contrast(byte[] buffer)
        ...
        static private byte[] ApplyKernel(byte[] buffer, int stride, CustomKernel customKernel)
        {
        ...
        static private byte[] Grayscale(byte[] buffer)
        ...
        static private byte[] AverageDither(byte[] buffer)
        {
            byte[] result = new byte[buffer.Length];
        ...
        static private byte[] OctreeQuantization(byte[] buffer)
        {
            byte[] result = new byte[buffer.Length];
        ...
        static private byte[] YGrayscale(byte[] buffer)
        {
            byte[] result = new byte[buffer.Length];
        ...
        static private byte[] CbInterpolate(byte[] buffer)
        {
            byte[] result = new byte[buffer.Length];
        ...
        static private byte[] CrInterpolate(byte[] buffer)
        {
            byte[] result = new byte[buffer.Length];
