/**
 * Copyright (C) )R) 2019 The Google Research Authors.
 *
...
private final class NetworkHelpers {
   ...
   */
  private NetworkHelpers(WifiManager wifiManager) {
   ...
   */
  private InetAddress getHotspotServerAddress() throws SocketException, UnknownHostException {
