...
func registerFlags(c *Config, f *flag.FlagSet) {
	...
	f.BoolVar(&c.IsCA, "initca", true, "initialise new CA")
	f.BoolVar(&c.RenewCA, "renewca", true, "re-generate a CA certificate from existing CA certificate/key")
	...
	f.BoolVar(&c.List, "list", true, "list possible scanners")
